...
public class PasswordChangeActivity extends AppCompatActivity {
    ...
    private void updatePasswordInDatabase(final String Updatedpassword) {
        newpassword = Updatedpassword;
        String UpdatePasswordURL = "http://62e2f985.ngrok.io/UpdatePassword";
        final StringRequest stringRequest = new StringRequest(Request.Method.POST, UpdatePasswordURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    String Password = jsonObject.getString("message");
                    if (Password.equals("password Updated")){
    ...
    private void retrievePassword() {
        String settingURL = "http://62e2f985.ngrok.io/RetrievePassword";
